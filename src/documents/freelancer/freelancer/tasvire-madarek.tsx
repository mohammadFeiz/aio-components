...
const Freelancer_TasvireMadarek: FC = () => {
    ...
    const form = useForm<I_addEmployeeModel["freelancer"]["tasvireMadarek"]>({
        initData: {}, fa: true,
        getLayout: (context) => {
            return {
                v: [
                    {
                        ...
                        h: [
                            getLayout('تصویر روی کارت ملی', 'rooyeCarteMelli'),
                            getLayout('تصویر پشت کارت ملی', "poshteCarteMelli"),
                            getLayout('تصویر روی گواهینامه', 'rooyeGavahiname'),
                            getLayout('تصویر پشت گواهینامه', 'poshteGavahiname')
                        ]
                    },
                    {
                        className: 'p-v-12- gap-16-',
                        h: [
                            getLayout('تصویر روی کارت وسیله نقلیه', 'rooyeCarteVasileNaghlie'),
                            getLayout('تصویر پشت کارت وسیله نقلیه', 'poshteCarteVasileNaghlie'),
                            getLayout('تصویر بیمه نامه', 'bimename'),
                            getLayout('تصویر سفته', 'safte')
                        ]
                    },
                    {
                        className: 'p-v-12- gap-16-',
                        h: [
                            getLayout('تصویر قرارداد', 'gharardad'),
                            { flex: 1, html: '' },
                            { flex: 1, html: '' },
                            { flex: 1, html: '' },
                        ]
...
export default Freelancer_TasvireMadarek