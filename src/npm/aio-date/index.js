...
var AIODate = /** @class */ (function () {
    function AIODate() {
        var _this = this;
        this.isThisWeek = function (date, jalali) {
            jalali = jalali === undefined ? _this.isJalali(date) : jalali;
            var _a = _this.convertToArray(date, jalali), year = _a[0], month = _a[1], day = _a[2];
            var days = _this.getDaysOfWeek([year, month, day]);
        ...
        this.isThisMonth = function (date, jalali) {
            jalali = jalali === undefined ? _this.isJalali(date) : jalali;
            var dateArray = _this.convertToArray(date, jalali);
            var _a = _this.getToday(jalali), year = _a[0], month = _a[1];
            if (dateArray[0] !== year) {
                return false;
            }
        ...
        this.compaire = function (date1, date2) {
            date1 = _this.convertToArray(date1);
            date2 = _this.convertToArray(date2);
        ...
        this.isLess = function (date1, date2) { return _this.compaire(date1, date2) === 'less'; };
        this.isEqual = function (date1, date2) { return _this.compaire(date1, date2) === 'equal'; };
        this.isGreater = function (date1, date2) { return _this.compaire(date1, date2) === 'greater'; };
        this.isBetween = function (date1, dates) { return _this.compaire(date1, dates[0]) === 'greater' && _this.compaire(date1, dates[1]) === 'less'; };
